...
PluginManagerDialog::PluginManagerDialog(QWidget *parent) :
    QDialog(parent),
    ui(new QGamaCore::Ui::PluginManagerDialog),
...
void PluginManagerDialog::addLoadedPlugin(const QString &name, int status, PluginInterface* plugin)
{
...
void PluginManagerDialog::on_toolButton_clicked()
{
...
void PluginManagerDialog::on_buttonBox_accepted()
{  
...
void PluginManagerDialog::on_treeWidget_Plugins_currentItemChanged(QTreeWidgetItem* current, QTreeWidgetItem* previous)
{
