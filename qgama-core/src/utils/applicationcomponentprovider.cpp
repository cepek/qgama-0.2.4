...
/** Function returning a pointer to the wanted top-level widget (window that is actually loaded
  ...
  */
QWidget* ApplicationComponentProvider::findTopLevelWidget(const QString &name)
{
...
/** Function returning a pointer to the wanted widget (widget that is actually loaded
  ...
  */
QWidget* ApplicationComponentProvider::findWidget(const QString &name)
{
    // get the list of active top-level widgets
...
/** Function returning a pointer to the wanted subwindow.
  ...
  */
QMdiSubWindow* ApplicationComponentProvider::findMdiSubWindow(const QString &file)
{
...
/**
  *
  */
PluginsManagerDialog* ApplicationComponentProvider::getPluginsManagerDialog()
{
...
/**
  *
  */
MainWindow* ApplicationComponentProvider::getMainWindow()
{
...
/**
  *
  */
ProjectsTreeWidget* ApplicationComponentProvider::getProjectsTreeWidget()
{
